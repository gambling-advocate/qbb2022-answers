...
1 + 1 + 1 + 1 + 1 + 1 + 1 + 0 + 1 + 1 = 9 out of 10 points possible
...
10. step 5 plot for variability in the time to fixation for each starting allele frequency. label the ticks and notate population size (0.5 pts for notes and labels)
  ...
  * good plot overall! I'd recommend ordering the x-axis data so the data and tick labels are in ascending order for allele frequency

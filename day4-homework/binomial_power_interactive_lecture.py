...
power2b = run_experiment(correct_the_pvalues = True)
#print(power2b)
...
fig, ax = plt.subplots()
sns.heatmap(power2b, vmin=None, cmap="Greys_r", xticklabels=tosses, yticklabels=probs, ax=None)
ax.title.set_text("Heatmap of power based on tosses and probability")
ax.set_ylabel("Probabilities")
ax.set_xlabel("Number of Iterations")
plt.show()
# plt.savefig("mh_correctedP.png")
